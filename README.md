...
# Chiến lược xử lý ngoại lai: clip, drop, hoặc impute
outlier_strategy = clip
detection_params_z_score_threshold = 2.5

[PATIENT_INFO]
# Thông tin bệnh nhân mới để dự đoán
# Format: [age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal, num]
